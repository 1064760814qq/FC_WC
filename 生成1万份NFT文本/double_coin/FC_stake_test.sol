...
/*
    ...
    function balance_of_this() public view {
        _FC.balanceOf(address(this));
    }
    ...
    onlyOwner
    {
         ...
         user._lastRewardTime =  now1_time.add(user.lockDays * 86400);
         user._left_balance = _left_balance  *10 **decimals();
         user._endTime = now1_time.add(user.lockDays * 86400 + every_months_time());
    }
    ...
    function get_months() public  returns (uint256) {
